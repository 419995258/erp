	...
	<form id="productfrom" class="easyui-form" method="post"
		...
		<table>
			...
			<tr>
				...
				<td width="250"><div align="left">
						<input name="passday" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">休息天数：</div></td>
				<td width="250"><div align="left">
						<input name="restday" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">病假天数：</div></td>
				<td width="250"><div align="left">
						<input name="sickday" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
			</tr>
			<tr>
				...
				<td width="250"><div align="left">
						<input name="allday" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">迟到天数：</div></td>
				<td width="250"><div align="left">
						<input name="lateday" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>

			</tr>
			<tr>
				<td width="80" align="right"><div align="right">早退：</div></td>
				<td width="250"><div align="left">
						<input name="inday" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">加班：</div></td>
				<td width="250"><div align="left">
						<input name="overday" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
