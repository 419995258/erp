	...
	<table id="productGrid" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'id',sortable:true">id</th>
				<th data-options="field:'pid',sortable:true">项目名称</th>
				<th data-options="field:'name',sortable:true">维护事项</th>
				<th data-options="field:'supplier',sortable:true">预计完成日期</th>
				<th data-options="field:'leader',sortable:true">时间记录</th>
				<th data-options="field:'tel',sortable:true">解决方案</th>
				<th data-options="field:'certificateNum',sortable:true">审查结果</th>
				<th data-options="field:'component',sortable:true">申报日期</th>
				<th data-options="field:'size',sortable:true">完成日期</th>
				<th data-options="field:'weight',sortable:true">审查人员</th>
