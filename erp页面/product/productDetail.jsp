...
<body class="easyui-layout">
	<form id="productDetailfrom" class="easyui-form"
		...
		<table>
			<tr>
				...
				<td width="250" align="left"><div align="left">
						<input id="pid" name="pid" type="text" size="30" class="easyui-textbox"></input>
					</div></td>
				<td width="80" align="right"><div align="right">商品名称：</div></td>
				<td width="250" align="left"><div align="left">
						<input id="name" name="name" type="text" size="30" class="easyui-textbox"
							data-options="required:true"></input>
					</div></td>
				<td width="80" align="right"><div align="right">供应商：</div></td>
				<td width="250"><div align="left">
						<input id="supplier" name="supplier" type="text" size="30"
			...
			<tr>
				...
				<td width="250"><div align="left">
						<input id="leader" name="leader" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">联系方式：</div></td>
				<td width="250"><div align="left">
						<input id="tel" name="tel" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">证书号：</div></td>
				<td width="250"><div align="left">
						<input id="certificateNum" name="certificateNum" type="text" size="30"
			...
			<tr>
				...
				<td width="250"><div align="left">
						<input id="component" name="component" type="text" size="30"
							class="easyui-textbox" data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">规格：</div></td>
				<td width="250"><div align="left">
						<input id="size" name="size" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">金重(k)：</div></td>
				<td width="250"><div align="left">
						<input id="weight" name="weight" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
			</tr>
			<tr>
				...
				<td width="250"><div align="left">
						<input id="subStone" name="subStone" type="text" size="30"
							class="easyui-textbox" data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">主石(ct)：</div></td>
				<td width="250"><div align="left">
						<input id="mainStone" name="mainStone" type="text" size="30"
							class="easyui-textbox" data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">金费：</div></td>
				<td width="250"><div align="left">
						<input id="goldCost" name="goldCost" type="text" size="30"
			...
			<tr>
				...
				<td width="250"><div align="left">
						<input id="handCost" name="handCost" type="text" size="30"
							class="easyui-numberbox" data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">数量：</div></td>
				<td width="250"><div align="left">
						<input id="quantity" name="quantity" type="text" size="30"
							class="easyui-numberbox" data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">成本：</div></td>
				<td width="250"><div align="left">
						<input id="cost" name="cost" type="text" size="30" class="easyui-numberbox"
							data-options="required:true">
					</div></td>
			</tr>
			<tr>
				...
				<td width="250"><div align="left">
				<img id="photoLink" src="" width="200px" height="150px"/>
						<!-- <input name="photoLink" type="file" size="10" value="选择图片"> -->
						<!-- <input id="photoLink" class="easyui-filebox" name="photoLink"
							data-options="prompt:'选择一张商品图片'" style="width: 100%"> -->
							<!-- <img id="photoLink" alt="" src=""> -->
			...
			<tr>
				...
				<td colspan="5"><div align="left">
						<input id="note" name="note" type="text" size="80" class="easyui-textbox"
		...
		$(function() {
			$.ajax({
		            ...
		            success : function(data) {
		            	...
		            	$("#leader").textbox("setValue", data.leader);
		            	$("#tel").textbox("setValue", data.tel);
		            	$("#certificateNum").textbox("setValue", data.certificateNum);
		            	$("#component").textbox("setValue", data.component);
