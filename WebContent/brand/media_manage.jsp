	...
	<table id="productGrid" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'id',sortable:true">id</th>
				<th data-options="field:'MMtype',sortable:true">类别</th>
				<th data-options="field:'name',sortable:true">项目：</th>
				<th data-options="field:'supplier',sortable:true">推广主题</th>
				<th data-options="field:'leader',sortable:true">推广目的人</th>
				<th data-options="field:'tel',sortable:true">推广形式</th>
				<th data-options="field:'certificateNum',sortable:true">平面类</th>
				<th data-options="field:'component',sortable:true">网络类</th>
				<th data-options="field:'size',sortable:true">电视类</th>
				<th data-options="field:'weight',sortable:true">户外类</th>
				<th data-options="field:'subStone',sortable:true">其他</th>
