	...
	<table id="productGrid" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'id',sortable:true">id</th>
				<th data-options="field:'pid',sortable:true">店铺地址</th>
				<th data-options="field:'name',sortable:true">店铺装修</th>
				<th data-options="field:'supplier',sortable:true">店铺装饰</th>
				<th data-options="field:'leader',sortable:true">店内气氛</th>
				<th data-options="field:'tel',sortable:true">商品陈列</th>
				<th data-options="field:'certificateNum',sortable:true">接待礼仪</th>
				<th data-options="field:'component',sortable:true">日期</th>
				<th data-options="field:'size',sortable:true">负责人</th>
