		...
		<table>
			<tr>
				...
				<td width="250"><div align="left">
						<input name="superPlatPeople" type="text" size="30"
							class="easyui-textbox" data-options="required:true"></input>
					</div></td>
			</tr>
			<tr>
				<td width="80" align="right"><div align="right">盘点人：</div></td>
				<td width="250"><div align="left">
						<input name="inventoryPeople" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
				<td width="80" align="right"><div align="right">盘点时间：</div></td>
				<td width="250"><div align="left">
						<input name="inventoryTime" type="text" size="30" class="easyui-datebox"
							data-options="required:true">
					</div></td>
