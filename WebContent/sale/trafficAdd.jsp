	...
	<form id="productfrom" class="easyui-form" method="post"
		...
		<table>
			<tr>
				...
				<td width="250" align="left"><div align="left">
						<input name="intime" type="text" size="30" class="easyui-datetimebox"
							data-options="required:true"></input>
					</div></td> 
				<td width="80" align="right"><div align="right">离开时间：</div></td>
				<td width="250"><div align="left">
						<input name="outtime" type="text" size="30"
							class="easyui-datetimebox" data-options="required:true"></input>
					</div></td>
			</tr>
			<tr>
				<td width="80" align="right"><div align="right">需求类型：</div></td>
				<td width="250"><div align="left">
						<input name="type" type="text" size="30" class="easyui-textbox"
			...
			<tr>
				<td width="80" align="right"><div align="right">成交/失败原因：</div></td>
				<td width="250"><div align="left">
				...
				<td width="250"><div align="left">
						<input name="diyConsultant" type="text" size="30" class="easyui-textbox"
							data-options="required:true">
					</div></td>
